...
local bankLocations = {
    {i = 108, c = 77, x = 241.38, y =225.36, z = 106.28, s = 0.8, n = "Zentralbank"}, -- blip id, blip color, x, y, z, scale, name/label 
...
Citizen.CreateThread(function()
    while true do
        ...
        if playerNearBank() and not inMenu then
            DisplayHelpText("Drücke ~INPUT_PICKUP~ um auf dein Bankkonto zuzugreifen!")
