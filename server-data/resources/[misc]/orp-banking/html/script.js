...
$('.close').click(function () {
    ...
    $.post('https://orp-banking/NUIFocusOff', JSON.stringify({}));
});

$('#withdraw').click(function (e) {
    e.preventDefault();
    $.post('https://orp-banking/withdrawl', JSON.stringify({
...
$('#deposit').click(function (e) {
    e.preventDefault();
    $.post('https://orp-banking/deposit', JSON.stringify({
...
$('#transfer').click(function (e) {
    e.preventDefault();
    $.post('https://orp-banking/transfer', JSON.stringify({
        to: $('#idval').val(),
