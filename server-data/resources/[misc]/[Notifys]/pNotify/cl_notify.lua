...
function SendNotification(options)
    ...
    local options = {
        ...
        text1 = options.text1 or "Empty Notification",
        text2 = options.text2 or "Empty Notification",
        timeout = options.timeout or 5000,
        progressBar = options.progressBar ~= false and true or false,
        closeWith = options.closeWith or {},
        animation = {
            open = options.animation.open or "gta_effects_open_left",
            close = options.animation.close or "gta_effects_close_left"
        },
        sounds = {
