        ...
        data = {                                    -- Data that is passed to Javascript
            ...
            style = {                               -- Wheel style settings
                ...
                slices = {                          -- Slice style settings
                    ...
                    hover = { ['fill'] = '#2060FF', ['stroke'] = '#000000', ['stroke-width'] = 2, ['opacity'] = 0.80 },
            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    labels = {"CANCEL", "FESSELMENÜ"},
                    commands = {"cancel", "zfesselmenuz"}
                },
        --[[    {
                    navAngle = 285,                 -- Oritentation of wheel
                    minRadiusPercent = 0.6,         -- Minimum radius of wheel in percentage
                    maxRadiusPercent = 0.9,         -- Maximum radius of wheel in percentage
                    labels = {"SALUTE", "FINGER", "PEACE", "FACEPALM", "CLAP", "FAIL", "CHEER", "LEAN", "FOLDARMS", "CROWDS"},
                    commands = {"e salute", "e finger", "e peace", "e palm", "e slowclap", "e fail", "e cheer", "e leanwall", "e foldarms", "e copcrowd2"}
                } ]]
            }
        }
    }
--[[    ['vehicles'] = {                                -- Example menu for vehicle controls when player is in a vehicle
        ...
        data = {                                    -- Data that is passed to Javascript
            ...
            style = {                               -- Wheel style settings
                ...
                slices = {                          -- Slice style settings
                    default = { ['fill'] = '#000000', ['stroke'] = '#000000', ['stroke-width'] = 3, ['opacity'] = 0.30 },
                    hover = { ['fill'] = '#2060FF', ['stroke'] = '#000000', ['stroke-width'] = 3, ['opacity'] = 0.80 },
            ...
            wheels = {                              -- Array of wheels to display
                {
                    ...
                    commands = {"engine", "save", "fdoors", "trunk", "hood"}
                }
            }
        }
    }]]
