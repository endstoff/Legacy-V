function GenerateReport(evidence) {
    ...
    html_header += "<div id=\"header_title\">" + 'BEWEISBERICHT' + "</div>";
    html_header += "<div id=\"header_seal\"></div>";
    html_header += "<div id=\"header_details\"><h2>" + 'Offizieller Bericht der polizeilichen Spurensicherung zu den gegebenen Hinweisen!' + "</h2>";
    ...
    for (i = 0; i < Object.keys(evidence).length; i++) {
        ...
        html_middle += "<div id=\"section_footer_block\">" + 'BEWEIS #' + (i + 1) + ' (' + evidence[i]["type"] + ')' + "</div>";
