Config = {
    License = 'e7b65ff4a6dae8fe099f4b4c5ca51d17', -- Insert your rcore license
    ...
    Text = {
        ...
        BALL_IN_HAND_BACK = "Zurück",
        AIM_LEFT = "Links",
        AIM_RIGHT = "Rechts",
        AIM_SLOWER = "Langsamer Positionieren",

        POOL = 'Billard',
        POOL_GAME = 'Billard Spiel',
        POOL_SUBMENU = 'Wähle die Ball Konfiguration!',
        TYPE_8_BALL = '8-ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Tisch aufsetzen',
        HINT_TAKE_CUE = 'Billard Kö nehmen',
        HINT_RETURN_CUE = 'Billard Kö zurückstellen',
        HINT_HINT_TAKE_CUE = 'Um Billard spielen zu können, nimm den Billard Kö vom Ständer',
        HINT_PLAY = 'Spielen',

        BALL_IN_HAND_LEFT = 'Links',
        BALL_IN_HAND_RIGHT = 'Rechts',
        BALL_IN_HAND_UP = 'Hoch',
        BALL_IN_HAND_DOWN = 'Runterwärts',
        BALL_POCKETED = '%s wurde eingelocht',
        BALL_IN_HAND_NOTIFY = 'Ein Spieler hat die Spielkugel in die Hand genommen',
        BALL_LABELS = {
            [-1] = 'Spielkugel',
            [1] = '~y~Volle 1~s~',
            [2] = '~b~Volle 2~s~',
