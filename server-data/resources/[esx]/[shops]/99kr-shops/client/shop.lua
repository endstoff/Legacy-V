...
CashRegister = function(titel)
        local elements = {
            {label = '<span style="color:lightgreen; border-bottom: 1px solid lightgreen;">Bestätigen</span>', value = "yes"},
            {label = 'Betrag zu Zahlen: <span style="color:green">$' .. payAmount ..'</span>'},
        }
            ...
            function(data, menu)
                ...
                if data.current.value == "yes" then
                    ...
                    ESX.UI.Menu.Open(
                        ...
                        {
                            title    = "Shop - Bezahlvorgang",
                            align    = 'center',
                            elements = {
                                {label = "mit Bargeld zahlen", value = "cash"},
                                {label = "mit Karte zahlen", value = "bank"},
                            },
                        },
