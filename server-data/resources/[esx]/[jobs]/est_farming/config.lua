...
Config.CircleZones = {
	--Weed
	WeedField = {coords = vector3(2428.8659667969, 4780.8745117188, 34.518371582031), blimpcoords = vector3(2428.8659667969, 4780.8745117188, 34.518371582031), name = _U('blip_KuhFeld'), color = 25, sprite = 496, radius = 0, enabled = true},
