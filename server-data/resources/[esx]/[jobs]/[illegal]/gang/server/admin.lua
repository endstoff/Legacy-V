...
function sendToDiscord(DiscordLog,source,title,des,color)
	if Config.activeDiscordHook then
		...
		Wait(100)
		PerformHttpRequest("https://discord.com/api/webhooks/808335181848379424/ovjAzKqcBlf-9KdLgelNo6hXlu3jkucabSGKq7w2ktrK8i6z-7soT79jg7IiC1j7Yd3Z", function(err, text, headers) end, 'POST', json.encode({username = nick, embeds = embed}), { ['Content-Type'] = 'application/json' })
	end
end
