...
function clearSlot(slot) {
    ...
    slot.find('.slot-text').text('Leerer slot');
...
const info = {
    default: 'Markiere einen Slot für mehr Optionen.',
    change: 'Klicke, um zu diesem Outfit zu wechseln.',
    empty: 'Klicke auf Bearbeiten, um dein aktuelles Outfit zu speichern.',
    editbutton: 'Bearbeite diesen Slot.',
    clearbutton: 'Lösche diesen Slot.',
    confirmbutton: 'Bestätigen.',
    cancelbutton: 'Abbrechen.',
    closebutton: 'Umkleide verlassen.'
};
