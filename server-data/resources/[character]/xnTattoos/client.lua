...
function CreateScale(sType)
	if scaleString ~= sType and sType == "OpenShop" then
		scaleType = setupScaleform("instructional_buttons", "Tattoo Shop öffnen", 38)
		scaleString = sType
	elseif scaleString ~= sType and sType == "Control" then
		scaleType = setupScaleform2("instructional_buttons", "Kameraansicht ändern", 21, "Deckkraft ändern", {90, 89}, "Tattoo Kaufen/Entfernen ", 191)
		scaleString = sType
	end
end
