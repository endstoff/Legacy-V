...
function RefreshBussHUD()
	...
	if ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'chiefofdepartment' or ESX.PlayerData.job.grade_name == 'chiefofacademy' then
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'chiefofdepartment' or ESX.PlayerData.job.grade_name == 'chiefofacademy' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
