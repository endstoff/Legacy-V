...
--[[ESX.RegisterServerCallback('est_impound:loadVehicles', function(source, cb)
...
ESX.RegisterServerCallback('est_impound:loadVehicle', function(source, cb, plate)
...
ESX.RegisterServerCallback('est_impound:isOwned', function(source, cb, plate)
...
AddEventHandler('est_impound:saveProps', function(plate, props)
