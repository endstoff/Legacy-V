...
Config.Strings = {
	ExitVehicle = "Verlass das Auto zum Tanken",
	EToRefuel = "Drücke ~g~E ~w~zum Tanken",
	JerryCanEmpty = "Kanister ist Leer",
	FullTank = "Tank ist voll",
	PurchaseJerryCan = "Drücke ~g~E ~w~um einen Kanister zu Kaufen ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Drücke ~g~E ~w~um das Tanken abzubrechen",
	CancelFuelingJerryCan = "Drücke ~g~E ~w~um Tanken abzubrechen",
	NotEnoughCash = "Nicht Genug Geld",
	RefillJerryCan = "Drücke ~g~E ~w~ um kanister nachzufüllen",
	NotEnoughCashJerryCan = "Nicht genug Geld um den kanister zu füllen",
	JerryCanFull = "Kanister ist voll",
	TotalCost = "Preis",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Drücke ~g~E ~w~um einen Kanister zu kaufen"
	Config.Strings.RefillJerryCan = "Drücke ~g~E ~w~um  kanister Nachzufüllen "
end
