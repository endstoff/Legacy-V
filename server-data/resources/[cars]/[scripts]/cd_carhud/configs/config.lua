...
----------------------------------------------- MAIN ------------------------------------------------
------------------------------------------------------------------------------------------------------
Config.Language = 'DE' --[ 'EN' / 'FR' / 'ES' / 'CZ' / 'PT' ]. (You can add your own locales to the Locales.lua. But make sure to add it here).
...
------------------------------------------ OPTIMISATION ----------------------------------------------
------------------------------------------------------------------------------------------------------
Config.DisableExitingVehicle = true --If enabled, you will not be able to press F to exit the vehicle while the seatbelt is enabled. [WARNING - If this is enabled, this will increase the ms usage of this script.]
...
Config.Settings = {
    ...
    key = 'f10', --Customise the key to open the settings UI.
