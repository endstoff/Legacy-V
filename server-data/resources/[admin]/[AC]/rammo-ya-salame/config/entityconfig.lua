...
EntityConfig = {}
EntityConfig.EntityDeleteCommand = 'entitywipe' -- if you write it on console, it deletes all the **entity** in game when cheaters spawn them
EntityConfig.CarDeleteCommand = 'carwipe' -- if you write it on console, it deletes all the **cars** in game when cheaters spawn them
EntityConfig.PedDeleteCommand = 'pedwipe' -- if you write it on console, it deletes all the **peds** in game when cheaters spawn them
EntityConfig.VSL = true -- it blocks cheater to spawn so many cars
EntityConfig.VehicleSpawnLimit = 4
EntityConfig.PSL = true -- it blocks cheater to spawn so many peds
EntityConfig.PedSpawnLimit = 4
EntityConfig.BlacklistEntity = true -- if true, cheater gets kicked when he spawns one of the blacklisted entity below
EntityConfig.BlacklistEntityBan = false
EntityConfig.BlacklistedEntity = { -- here you can add or remove blacklisted entities
...
EntityConfig.CarSpawnDebug = false -- it shows all spawned vehicles in console. (we recommend you to keep it false)
EntityConfig.PropSpawnDebug = false -- it shows all spawned props/entities in console. (we recommend you to keep it false) 
EntityConfig.AllEntityDelete = false -- if true, deletes all spawned cars, entities and peds (we recommend you to keep it false)
EntityConfig.AllPedDelete = false -- if true, deletes all peds. (if you use peds in your server keep it false.)
EntityConfig.AllPropDelete = false -- if true, deletes all props/entities. (if you use props/entities in your server keep it false.)
EntityConfig.AllCarDelete = false -- if true, deletes all cars. (if you use cars in your server keep it false.)
EntityConfig.PropWhitelist = false -- it deletes objects which is not whitelisted
EntityConfig.PropKick = false -- it kicks cheater if he spawns objects which is not whitelisted
EntityConfig.PropBan = false -- it bans cheater if he spawns objects which is not whitelisted
EntityConfig.WLProps = { -- here you can add or remove whitelisted objects
    1760825203,
    3258159972,
    3420629148,
    2518469636,
