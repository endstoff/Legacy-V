...
CREATE TABLE IF NOT EXISTS `phone_calls` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `owner` varchar(10) NOT NULL COMMENT 'Num solcher Besitzer',
  `num` varchar(10) NOT NULL COMMENT 'Referenznummer kontaktieren',
  `incoming` int(11) NOT NULL COMMENT 'Definiert, ob wir der Urheber der Anrufe sind',
  `time` timestamp NOT NULL DEFAULT current_timestamp(),
  `accepts` int(11) NOT NULL COMMENT 'Anruf annehmen oder ablehnen',
  PRIMARY KEY (`id`)
