Config = {}
Config.ServerName = 'Unity-V'
Config.Locale = 'de' -- Currently supported: nl, en, tr, fr, br, de, fa, pt, es. Your translation file is really appreciated. Send it to our Github repo or Discord server.
...
Config.UseLicense = true -- You must have esx_licenses working on your server. 
Config.useAdvancedShop = false -- DP_Framework shop system. Not shared, sorry. Just set to false and use the in-build custom shop.
...
Config.CloseUiItems = {'phone','radio', 'weed_seed', 'tunerchip', 'fixkit', 'medikit', 'firstaid', 'vicodin', 'adrenaline', 'vuurwerk', 'vuurwerk2', 'vuurwerk3', 'vuurwerk4', 'armbrace', 'neckbrace', 'bodybandage', 'legbrace', 'bandage', 'billet'} -- List of item names that will close ui when used.
