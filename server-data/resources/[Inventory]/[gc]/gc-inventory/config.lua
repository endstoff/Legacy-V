...
Config.MaxWeight = 80000 --SAME AS THE DEFAULT ON ES EXTENDED CONFIG

-- List of item names that will close ui when used
Config.CloseUiItems = {"radio", "idcard", "donut", "nugget", "cigarette", "beer", "methburn", "vodka", "bread", "coffee", "radio", "coke", "meth", "medikit", "binoculars", "bulletproof", "oxygenmask", "trailburst", "shotburst", "starburst","fountain", "cuffs", "cuff_keys"}
